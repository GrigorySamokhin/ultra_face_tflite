...
parser.add_argument('--img_path', type=str, default='/Users/grigorysamokhin/Desktop/Ultraface_tflite/tf/imgs/test_input.jpg', help='Image path for inference')
...
if __name__ == '__main__':
    ...
    filepath = '/Users/grigorysamokhin/Desktop/Ultraface_tflite/tflite/model/slim320_f16.tflite'# f"pretrained/version-{args.net_type}-320_without_postprocessing.tflite"
